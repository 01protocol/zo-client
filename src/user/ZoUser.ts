...
export class ZoUser extends ZoDBUser {
  ...
  async subscribe() {
    ...
    this.margin.eventEmitter!.addListener(UpdateEvents.marginModified, () => {
      this.eventEmitter!.emit(UpdateEvents.marginModified)
    })
    this.margin.control.eventEmitter!.addListener(UpdateEvents.controlModified, () => {
    ...
    this.state.cache.eventEmitter!.addListener(UpdateEvents._cacheModified, () => {
