...
import { accountFlagsLayout, publicKeyLayout, u128, u64, i128 } from "./layout";
...
export class ZoMarket {
  ...
  filterForOpenOrders(
    bids: Orderbook,
    asks: Orderbook,
    openOrdersAccounts: ZoOpenOrders[],
  ): Order[] {
...
export const _OPEN_ORDERS_LAYOUT_V2 = struct([
  ...
  u64("borrowedCoin"),
  i128("realizedPnl"),
  u128("longFundingIndex"),
  u128("shortFundingIndex"),
  u64("coinOnBids"),
  u64("coinOnAsks"),
