export type Zo = {
  ...
  "instructions": [
    ...
    {
      "name": "createSpecialOrdersAccount",
      "accounts": [
        {
          "name": "state",
          "isMut": false,
  ...
  "errors": [
    ...
    },
    {
      "code": 6075,
      "name": "InvalidXMint",
      "msg": "The X Mint is not associated to the market"
    },
    {
      "code": 6076,
      "name": "InvalidState",
      "msg": "The state key is invalid"
    },
    {
      "code": 6077,
      "name": "InvalidZamm",
      "msg": "The zamm key is invalid"
    },
    {
      "code": 6078,
      "name": "SpecialOrdersFull",
      "msg": "Max number of special orders reached"
    },
    {
      "code": 6079,
      "name": "SpecialOrderNotTriggered",
      "msg": "Special order not triggered"
    },
    {
      "code": 6080,
      "name": "SpecialOrderNotFound",
      "msg": "Special order does not exist"
    },
    {
      "code": 6081,
      "name": "UncancelledSpecialOrders",
      "msg": "There are uncancelled special orders"
    }
  ]
}
