...
## [0.8.0]
- Added Power Perps Support
- Removed cache as param for MarginWeb3 Functions
- Added liquidation calculations to MarginWeb3
- Added margin exists function to check if margin exists
- Added state & cache subscriptions
- 
