...
exports.setLayoutEncoder = exports.setLayoutDecoder = exports.accountFlagsLayout = exports.selfTradeBehaviorLayout = exports.orderTypeLayout = exports.sideLayout = exports.VersionedLayout = exports.WideBits = exports.i128 = exports.u128 = exports.i64 = exports.u64 = exports.publicKeyLayout = exports.zeros = void 0;
...
class SignedBNLayout extends buffer_layout_1.Blob {
    decode(b, offset) {
        return new bn_js_1.default(super.decode(b, offset), 10, "le").fromTwos(8 * this.span);
    }
    encode(src, b, offset) {
        return super.encode(src.toTwos(8 * this.span).toArrayLike(Buffer, "le", this.span), b, offset);
    }
}
...
function i64(property) {
    return new SignedBNLayout(8, property);
}
exports.i64 = i64;
...
function i128(property) {
    return new SignedBNLayout(16, property);
}
exports.i128 = i128;
