...
exports.EVENT_QUEUE_LAYOUT = exports.REQUEST_QUEUE_LAYOUT = exports.decodeEventQueue = exports.decodeRequestQueue = exports.decodeEventsSince = exports.EVENT_QUEUE_HEADER = void 0;
...
exports.EVENT_QUEUE_HEADER = (0, buffer_layout_1.struct)([
    (0, buffer_layout_1.blob)(5),
    (0, layout_1.accountFlagsLayout)("accountFlags"),
    (0, buffer_layout_1.u32)("head"),
    (0, layout_1.zeros)(4),
...
const EVENT = (0, buffer_layout_1.struct)([
    ...
    (0, layout_1.u128)("orderId"),
    (0, layout_1.publicKeyLayout)("control"),
    (0, layout_1.u64)("clientOrderId"),
]);
...
function decodeEventsSince(buffer, lastSeqNum) {
    const header = exports.EVENT_QUEUE_HEADER.decode(buffer);
    const allocLen = Math.floor((buffer.length - exports.EVENT_QUEUE_HEADER.span) / EVENT.span);
    ...
    for (let i = 0; i < missedEvents; ++i) {
        ...
        const event = decodeQueueItem(exports.EVENT_QUEUE_HEADER, EVENT, buffer, nodeIndex);
...
function decodeEventQueue(buffer, history) {
    const { header, nodes } = decodeQueue(exports.EVENT_QUEUE_HEADER, EVENT, buffer, history);
...
exports.EVENT_QUEUE_LAYOUT = {
    HEADER: exports.EVENT_QUEUE_HEADER,
    NODE: EVENT,
};
