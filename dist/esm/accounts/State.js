 ...
 */
export default class State extends BaseAccount {
    ...
    static getSigner(stateKey, programId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PublicKey.findProgramAddress([stateKey.toBuffer()], programId);
        });
    }
    /**
    ...
    static load(program, k) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cache = yield Cache.load(program, data.cache, data);
            return new this(program, k, data, signer, cache);
        });
    }
    static fetch(program, k) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = (yield program.account["state"].fetch(k, "recent"));
            ...
            return Object.assign(Object.assign({}, data), { vaults: data.vaults.slice(0, data.totalCollaterals), collaterals: data.collaterals
                    ...
                    .map((x) => (Object.assign(Object.assign({}, x), { oracleSymbol: loadSymbol(x.oracleSymbol) }))), perpMarkets: data.perpMarkets.slice(0, data.totalMarkets).map((x) => (Object.assign(Object.assign({}, x), { symbol: loadSymbol(x.symbol), oracleSymbol: loadSymbol(x.oracleSymbol) }))) });
        });
    }
    refresh() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getMarketBySymbol(sym) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._getMarketBySymbol[sym]) {
                this._getMarketBySymbol[sym] = yield ZoMarket.load(this.connection, this.getMarketKeyBySymbol(sym), this.provider.opts, ZO_DEX_PROGRAM_ID);
            }
