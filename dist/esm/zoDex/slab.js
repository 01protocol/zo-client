...
SLAB_NODE_LAYOUT.addVariant(1, struct([
    // Only the first prefixLen high-order bits of key are meaningful
    u32("prefixLen"),
    u128("key"),
    seq(u32(), 2, "children"),
]), "innerNode");
SLAB_NODE_LAYOUT.addVariant(2, struct([
    u8("ownerSlot"),
    u8("feeTier"),
    blob(2),
    u128("key"),
...
export const SLAB_LAYOUT = struct([
    SLAB_HEADER_LAYOUT,
    seq(SLAB_NODE_LAYOUT, offset(SLAB_HEADER_LAYOUT.layoutFor("bumpIndex"), SLAB_HEADER_LAYOUT.offsetOf("bumpIndex") - SLAB_HEADER_LAYOUT.span), "nodes"),
]);
export class Slab {
